...
contract PaintingNFT is ERC721{
    ...
    function createListing(string memory _title, string memory _description, uint _price) public minPrice(_price) returns(uint){
    ...
    //     require(listing.owner == msg.sender,"You are not the owner of the contract, only the owner can remove the listing");
    //     _;
    // }
